...
// Evolve function to update the state of the application
App.evolve = function() {
...
// Function to add new particles to the simulation
App.birth = function() {
  var x, y;
...
// Function to remove a particle from the simulation
...
// Function to initialize the drawing canvas
...
App.dataXYtoCanvasXY = function(x, y) {
  ...
  var xx = this.xC + x * zoom * this.dataToImageRatio,
      yy = this.yC + y * zoom * this
.dataToImageRatio;
  
  return {x: xx, y: yy};
};

// Event listener to initialize the application after DOM content is loaded
